...
// Pre-graduation BABYINU price, computed from the Pons bonding curve.
//
// Until BABYINU graduates off the Pons V2 bonding curve there is no Uniswap pool,
...
// real USD price for BABYINU today:
//
//   GET {ponsApi}/api/pons-v2-market/{token}/chart?range=1d
//     -> { points: [{ t, price, ... }] }        price = NVDA per BABYINU
...
// pair for BABYINU itself takes over (see routes/stats.js merge order) and this
...
/** Pure: latest curve price (NVDA per BABYINU) out of a Pons chart payload, or null. */
