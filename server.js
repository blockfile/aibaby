...
app.get('/', (req, res) => {
  res.json({
    name: 'aibaby-api',
    description: 'BABYINU market cap, holder count, what holders were paid in NVDA and AI, and the BABYINU bought back and kept, for the Baby Artificial Inu site',
